...
def validate_contracts(config: Dict[str, Any], resolved: bool = False) -> None:
    ...
    # - Si memory_policy == "finite_window": memory_mode debe ser "window" y memory_window_length > 0
    ...
    # - Si transfer_convention == "standard" y harmonic_condition == "1_plus_WN"
    #   permitir solo si config["allow_nonstandard_sign_pairing"] == True; de lo contrario ValueError
    ...
    # - Si transfer_convention == "opposite_sign" y harmonic_condition == "1_minus_WN"
    #   permitir solo si config["allow_nonstandard_sign_pairing"] == True; de lo contrario ValueError
