...
def _adm_step(
    ...
    #
    # The Gamma ratio Gamma(2q+1)/Gamma(2q+2) = 1/(2q+1) accounts for the
    # fractional power convolution in Adomian series for Caputo operators.
    # --------------------------------------------------------------------------
    ratio_A2 = gf["g2q1"] / gf["g2q2"]     # Gamma(2q+1) / Gamma(2(q+1))
    ...
    ratio_A3b = gf["g3q1"] / gf["g3q3"]                  # Gamma(3q+1)/Gamma(3(q+1))
