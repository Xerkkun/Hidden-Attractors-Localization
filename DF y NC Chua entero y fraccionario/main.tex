...
Los resultados numéricos promovidos del caso entero se presentan en su
sección correspondiente. Para el Chua fraccionario no suave con
\(q=0.9998\), los resultados se incorporarán exclusivamente después de
completar las corridas postransitorias vigentes y su continuación causal. El
caso con no linealidad \(\arctan\) permanece en esta actualización como
desarrollo metodológico para generación de semillas, sin resultados dinámicos
finales promovidos.
