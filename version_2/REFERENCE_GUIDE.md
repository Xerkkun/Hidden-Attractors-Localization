...
The library is backed by a robust test suite (at the current thesis-freeze audit, the suite reports 947 passed tests and 28 skipped tests; future runs should be checked against `validation/freeze_audit/`):
