...
| Arctan Wu2023/c590 | `python examples/chua_arctan_wu2023/run_example.py --quick` | Separates non-promoted bibliographic reproduction from a proposed Caputo full-history lane |
