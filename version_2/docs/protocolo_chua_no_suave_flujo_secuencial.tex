...
\begin{lstlisting}
from hidden_attractors.models import chua_nonsmooth_parameters
...
\begin{lstlisting}
hidden-attractors-unified-chua --model nonsmooth --q 0.9998 --print-command
\end{lstlisting}
...
\begin{center}
\small
\begin{tabular}{@{}L{0.20\textwidth}L{0.16\textwidth}L{0.56\textwidth}@{}}
\toprule
Bloque & Estado & Uso \\
\midrule
