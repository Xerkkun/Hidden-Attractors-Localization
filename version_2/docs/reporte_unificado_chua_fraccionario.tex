...
El caso Chua arctan fraccionario está implementado algebraicamente, pendiente de validación completa de ocultedad. No se promueve como atractor oculto verificado en esta versión.

La formulación algebraica, los equilibrios, el Jacobiano y el split de Lur'e están implementados. La guía no afirma reproducción completa ni ocultedad verificada del caso arctan mientras no exista una rama robusta, referencia dinámica promovida, comparación publicada y paquete de cuencas completo. Esto evita convertir un caso implementado en una conclusión científica más fuerte que la evidencia disponible. 

El flujo de trabajo completo que queda pendiente para este caso de estudio comprende:
\begin{enumerate}
  ...
  \item la continuación paramétrica completa;
  \item la simulación temporal mediante los integradores Caputo ABM o EFORK;
  \item el muestreo de esferas y vecindades de todos los puntos de equilibrio;
  \item la clasificación de ocultedad bajo criterios estrictos y conservadores.
\end{enumerate}
