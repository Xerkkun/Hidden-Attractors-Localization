...
\input{report_sections/23_confiabilidad_predictibilidad_transitorios}
...
\input{report_sections/24_cobertura_comparativa_sistemas}
...
\clearpage
\appendix
\part{Identidades algebraicas y resultados gráficos}
