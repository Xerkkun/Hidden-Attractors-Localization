...
\cref{sec:resultados-piloto-gt} documenta la ejecución B0--B2 para PLL,
...
B1--B2 es $26.24\%$ para los PP y $10.69\%$ para DF1.
\ifHAFOBasinMaterial
...
En B0--B2, $p_+$ converge de manera
robusta al foco y alcanza EV--TG3, mientras $p_-$ queda como transitorio acotado
sin destino y en EV--TG2.
\ifHAFOBasinMaterial
El bracket propuesto se rechaza porque sus extremos
siguen sin resolver; no existe trayectoria de borde ni EV--TG4.
\fi
...
\ifHAFOBasinMaterial
PP interiores y DF exterior; tercer destino en el bracket, máximo EV--TG2.
\else
Semillas PP y DF disponibles para comparación dinámica.
\fi\\
PLL & Dos PP sobre círculos singulares & Cubierta angular &
\ifHAFOBasinMaterial
$p_+$ alcanza EV--TG3; $p_-$ y el borde quedan sin resolver.
\else
...
La corrida contiene 50 comprobaciones aprobadas y ninguna fallida. Los campos,
jacobianos, determinantes, simetrías y raíces se reconstruyeron directamente
desde las ecuaciones, de manera independiente de las nubes dinámicas. El
alcance de esta evidencia es algebraico. Los artefactos de la
