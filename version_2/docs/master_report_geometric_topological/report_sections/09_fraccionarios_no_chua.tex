...
Danca~\cite{Danca2017}. Además, el software evaluó el Lorenz estándar y otra
parametrización de RF como referencias para exponentes de Lyapunov, así como
...
Ecuaciones, parámetros, equilibrios y espectros recalculados, junto con un
...
Los diseños para Genesio--Tesi, sistemas memristivos y otras familias que no
cuentan con una ejecución registrada se mantienen como propuestas. En cambio,
los cinco sistemas de referencia dinámica se desarrollan en esta sección hasta
el nivel algebraico y numérico alcanzado por las corridas disponibles. La
ausencia de continuación desde una semilla y de sondeos de vecindad impide
interpretar sus exponentes de Lyapunov como evidencia de ocultedad.

Los datos de referencia se conservan en
\path{version_2/validation/references/published_validation_data_extraction_v1.json};
y su clasificación procede de
...
Las comprobaciones se ejecutaron en un kernel Wolfram Language sin estado
persistente. Se usaron parámetros racionales
...
\begin{enumerate}
 ...
 \item Los espectros de Lorenz satisfacen los polinomios característicos y las
 identidades de traza obtenidas a partir de las ecuaciones declaradas.
 ...
 generar semillas; todavía no se han obtenido raíces numéricas validadas.
