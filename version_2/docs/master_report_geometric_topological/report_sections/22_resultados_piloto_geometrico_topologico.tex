...
La campaña B0--B2 preregistrada en la
\cref{sec:campana-gt} integró el PLL lead--lag y el MAVPD con $q=1$, y
...
semillas con un banco trazable y criterios de evidencia.\\
FPP--A & Volterra y expansión Picard de Caputo; ABM causal
\cite{DiethelmFordFreed2002}. & Formulación evaluada: interpretar $JF=0$ como
...
Las magnitudes reportadas proceden de la campaña local. Los modelos y métodos
componentes proceden de las referencias citadas; el elemento específico
evaluado es la ruta FPP--A basada en
\eqref{pilot:eq-wu-picard-expansion}, cuyo alcance observado en Wu es EV--TG2.

\subsection{Trabajo pendiente para ampliar el nivel de evidencia}
