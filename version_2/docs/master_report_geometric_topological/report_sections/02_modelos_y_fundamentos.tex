...
El análisis de las ecuaciones incluye sus equilibrios, sus jacobianos y su
polinomio característico antes de introducir la estabilidad fraccionaria; así,
el criterio de Matignon se aplica a un
...
hipótesis usuales de integrabilidad. Esta ley para integrales es distinta de
...
La ruta numérica se desarrolla en \cref{sec:abm}. Una validación preliminar
consiste en resolver una ecuación lineal cuya solución se exprese con
...
corta requiere identificar la parte eliminada del integral y acotar el error;
...
La relación en Laplace se obtiene directamente de \cref{eq:caputo}. Para hacer
