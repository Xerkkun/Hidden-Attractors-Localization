...
\subsection{Método de estudio: definición, hipótesis, prueba y cálculo}
...
análisis del PLL emplea retornos módulo $2\pi$, separatriz cilíndrica y una
métrica envuelta.
...
órbita periódica. Así, los teoremas de punto fijo desarrollados por Amster pueden
...
6 & Poincaré, monodromía y Floquet & Teoría geométrica II & Reconstruir el multiplicador del ciclo PLL y verificar el retorno MAVPD. \\
...
10 & Cuencas, fronteras y ocultedad & Metodología y resultados de este volumen & Sustituir la frase ``se ve oculto'' por un protocolo de separación explícito. \\
11 & Semidinámica Caputo en historias & Capítulo fraccionario de esta guía & Diferenciar términos libres, perfiles admisibles, cuenca relativa y reinicios. \\
\bottomrule
\end{longtable}

\subsection{Actividades guiadas aplicadas a los sistemas}
...
\begin{enumerate}[label=\textbf{A\arabic*.}]
 ...
 los sistemas analizados y escriba
