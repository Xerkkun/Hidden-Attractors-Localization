...
Los resultados se agrupan en reconstrucciones bibliográficas y casos obtenidos
por la metodología propuesta. En el caso no suave se completa el primer radio
con contactos. Para \texttt{c590} se distingue la partición local
\(r\leq0.3\) de la evaluación macroscópica en \(r=1\) y \(r=2\).
...
trayectorias obtenidas con sus protocolos reconstruidos. La continuación no
