...
En \texttt{c590} se añadió una evaluación macroscópica en \(r=2\) después del
...
La atribución bibliográfica distingue las funciones de cada tipo de fuente. La
definición, la localización y los parámetros de cada atractor se atribuyen a artículos de
investigación
