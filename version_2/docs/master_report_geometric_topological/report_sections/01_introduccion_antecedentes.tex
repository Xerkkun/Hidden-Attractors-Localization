...
atracción intersecta toda vecindad de, al menos, un punto de equilibrio. En ese
...
Se desarrollan dos rutas complementarias:
...
En \texttt{c590}, los sondeos comprenden también \(r=2\); el primer contacto
se observa en \(r=1\). El mayor radio local sin contactos y los
bloques macroscópicos se reportan por separado. El alcance \emph{local} se fija
por el protocolo predefinido. Los cálculos cubren radios, geometrías,
cantidades de muestras y horizontes declarados. Una demostración de ocultedad
exigiría excluir el continuo de datos iniciales en alguna vecindad de cada
equilibrio, bajo el convenio de memoria declarado, y justificar el destino
asintótico correspondiente. Describir toda la cuenca es un problema más
amplio; la exclusión puede probarse mediante regiones invariantes o un
certificado validado de no alcance. En Caputo debe especificarse además la
clase de perfiles admisibles sobre la que se formula esa exclusión.
...
La reconstrucción conserva la ecuación, los
...
al aplicar el cierre armónico entero a los parámetros publicados.
La ruta propuesta usa los mismos parámetros
...
\toprule
Referencia & Elemento recuperado & Función metodológica\\
\midrule
Leonov--Kuznetsov
...
\caption{Operaciones matemáticas asociadas con el estado del arte.}
\label{tab:articulos-operaciones}\\
\toprule
Núcleo & Artículos & Formalismo reconstruido & Alcance de la interpretación \\
\midrule
\endfirsthead
\toprule
Núcleo & Artículos & Formalismo reconstruido & Alcance de la interpretación \\
...
son formulaciones propuestas para Caputo y deben conservar el formalismo de
memoria. \\
Geometría del campo
...
Relacione los formalismos de la tabla con sus aplicaciones: atractores
...
¿cuáles son las hipótesis de cada método y qué conclusiones permiten
obtener en el sistema considerado?
\end{bloqueestudio}
\fi

Los fundamentos de la localización y la definición de ocultedad se desarrollan
en \cite{LeonovKuznetsovVagaitsev2011,Leonov2013HiddenAttractors,Danca2017,KuznetsovEtAl2017,Wu2023ArctanChua}.
Los métodos geométricos complementarios se estudian en
\cite{DudkowskiPrasadKapitaniak2017,GuanXie2021Connecting,GodaraEtAl2018CriticalSurfaces}.
Las monografías \cite{PhamEtAl2018HiddenAttractors,PhamVolosKapitaniak2017Systems,WangKuznetsovChen2021Multistability}
ofrecen una clasificación de familias y fenómenos de multistabilidad.
