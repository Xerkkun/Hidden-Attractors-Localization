...
En Amster, el adjetivo \emph{topológico} designa herramientas que garantizan
ceros o puntos fijos sin construir una fórmula explícita para ellos
\cite{Amster2021MetodosTopologicos}; no constituye por sí mismo una afirmación
de caos topológico.
...
La continuación armónica transporta primero una semilla aproximada. Una
formulación más rigurosa consiste en corregir cada nodo mediante la resolución
de $P_\lambda(z)-z=0$ y en calcular el grado o el índice local del punto fijo. Así se
separan:
