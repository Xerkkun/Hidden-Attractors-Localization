\section{Propuestas teóricas del proyecto y frontera de novedad}
\label{part:theory}

\subsection{Regla de atribución}
...
\cite{sayed2020}. Por ello, ninguno de esos ingredientes aislados se presenta
como nuevo.

La novedad potencial del proyecto reside en una \emph{integración
especializada}: decidir antes de la búsqueda si una realización escalar es
...
\caption{Frontera entre fundamento conocido y propuesta del proyecto.}
...
especializado potencialmente original.\\
...
\cite{sayed2020} & No es nueva; se usa para transportar contratos de cuenca.\\
Diccionario MIMO & Lur'e y balance multivariable
\cite{bonani1999,rogov2019} & Síntesis para candidatos ocultos; no invención
de MIMO.\\
Historia única de Caputo & Ecuación de Volterra & Propuesta
teórico--numérica más fuerte del proyecto.\\
Machado \(N^\mu\) & Función descriptiva fraccionaria publicada
\cite{Machado2015FDF} & No es nueva; se propone separar residuo auxiliar y
residuo físico en cada semilla.\\
Puntos perpetuos enteros & Condición \(J_f f=0\) y localización heurística
\cite{Prasad2015Perpetual,DudkowskiPrasadKapitaniak2017} & No son nuevos ni
suficientes; se integran como carril de semillas.\\
...
Disciplina metodológica potencialmente original.\\
...
\begin{proposalbox}
\textbf{Aporte propuesto.} El criterio convierte la inspección informal de una
...
\begin{remark}
La equivalencia afín de sistemas fraccionarios no se reclama como nueva; la
literatura incluye transformaciones afines para autorreproducción de
atractores ocultos \cite{sayed2020}. La contribución del presente flujo es
transportar también el contrato de ocultedad y las tolerancias.
\end{remark}
...
\end{align}
Son identidades algebraicas conocidas, no resultados nuevos. Su utilidad aquí
es exhibir canales escalares de cuadrados o cubos cuando ello simplifica
...
\begin{proposalbox}
\textbf{Aporte propuesto.} Acoplar el certificado D0/T1/M1 con
\cref{eq:th-dc-balance,eq:th-harmonic-balance}; una semilla M1 sólo se promueve
si satisface fase, cierre DC, residuo de armónicos omitidos y residual del
campo original. Esto traslada balance armónico MIMO conocido a un contrato
...
\begin{proposalbox}
\textbf{Aporte propuesto.} La historia única, el campo final congelado y el
reset común de todas las sondas forman un contrato explícito. Su fundamento es
