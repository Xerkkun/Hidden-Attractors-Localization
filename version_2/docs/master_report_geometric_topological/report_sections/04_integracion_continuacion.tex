...
objetivo con el mismo instante inicial y el mismo convenio de memoria que las
trayectorias empleadas en los sondeos. De esta ejecución se descarta el
transitorio y se construye la nube de referencia \(\target\) usada por el
clasificador.
