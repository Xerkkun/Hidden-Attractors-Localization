...
operación. Su uso es alternativo al de una función descriptiva que ya contenga
la misma pendiente, pues la combinación contaría esa contribución dos veces. En
una característica PWA sobre una frontera se necesita especificar pendiente lateral, derivada de
...
pertenencia del objetivo al rango de \(N\) y el control de
\begin{equation}
 \frac{dA}{d\mu}
...
\end{equation}
Las evaluaciones sesgadas registradas en la validación disponible usan \(\mu=1\); coinciden
