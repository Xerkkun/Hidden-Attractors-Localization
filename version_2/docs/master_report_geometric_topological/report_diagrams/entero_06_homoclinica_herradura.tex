...
\small\textbf{Intersección transversal y dinámica simbólica.}
...
símbolos. El diagrama representa la implicación del teorema de
Smale--Birkhoff bajo sus hipótesis de hiperbolicidad y transversalidad.
\end{minipage}
\end{minipage}
\end{center}
