...
from validation.python.lyapunov_method_registry import (
...
def assess_phase_f_closure(
    *,
    ...
    registry: Mapping[str, LyapunovMethodInfo] = ALL_VALIDATION_LYAPUNOV_METHODS,
    ...
    return {
        ...
        **evidence_summary,
        ...
        "current_evidence_limitations": [
            "fractional_variational_abm_qr has no passing published-benchmark or accepted-policy validation in this record.",
            "The Fischer 2020 cloned-dynamics discrepancy remains unresolved in this record.",
            "No validated fractional Lyapunov method is applied to every fractional candidate in this record.",
            "Two-method sign agreement is unavailable for the applicable fractional methods in this record.",
            "The F5 diagnostic set is not fully compatible across all cases in this record.",
        ],
    }
